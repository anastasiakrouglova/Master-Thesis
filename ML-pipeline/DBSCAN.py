...
def DBSCAN(data, max_frequency): 
    # good max_frequency = 2000
    freq_pow_array_normalized = preprocessing_DBSCAN(data, max_frequency) 
    ...
    # Get eps en min_samples van function optimization
...
def preprocessing_DBSCAN(data, max_frequency):
    ...
    data_array_normalized = StandardScaler().fit_transform(data_array)
