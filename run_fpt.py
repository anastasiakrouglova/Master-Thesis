...
path_input = 'fpt/data/input/' #scores/
...
df = ser.read_csv(path_output+filename+'.csv')  
...
# ser.save(spectrogram, filename=filename, dir=path_output)
# selection = ser.load(filename=filename, dir=path_output)

# print(selection)

# spec = from_csv(filename)
